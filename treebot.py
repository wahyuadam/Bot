...
ki = LINETCR.LINE()
ki.login(token="En62AxI4m5pbquE9BxN0.MsOi6uVzxa4qA+cHgMnbWa.4oZBsg4Xe0YFh8dZtY4nhiepDO78FgrnQ3P8MARxUZo=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EnE5krPv5gfb8fjWdIW7.7Vbk3zfGuJk3W4wl8d8brW.slETAAijDQIklYE4T1tXjLeChLbyIbG8t57QZjxsiPg=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EnBdOPUH3ta0KrVPcfDc.206JUnl6CWcOivpdHpNtZa.y6thnDgQzNqwSgpUP7Qu6JDFfG2W91QookBHnC9/dEE=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EnY3DksW3naPSq2dbc06.rlS4MMX9nYUjawGSeXG6HG.zWB3OfqdKSuuPcn43N/6a2wSgqYGajzA3HSd2Rp5pMY=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Enx9MYWVou14uaLQ26Qa.X0ZV0IJxvANMEp376mU+QG.azVRauStJDuUuRhEDYohKRp1q2Oc+cHzuamfVhn1VF0=")
ki5.loginResult()
...
Bots = [mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,"u6b34b703cbc5fc83cd1e5b6832a05352","u26e4eb388bac83d7631cec7a3acb6d8a"]
admsa = "u6b34b703cbc5fc83cd1e5b6832a05352"
admin = "u6b34b703cbc5fc83cd1e5b6832a05352","u26e4eb388bac83d7631cec7a3acb6d8a","u992a08e94bd95c0e106bf0a11a6341c0"
                   ...
                   if wait["commentOn"] == True:
                      if posts["userInfo"]["writerMid"] in wait["commentBlack"]:
                         pass
                          ...
                          cl.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOT"])
                          ki.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOT"])
                          ki2.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOT"])
                          ki3.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOT"])
                          ki4.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOT"])
                          ki5.comment(posts["userInfo"]["writerMid"],posts["postInfo"]["postId"],wait["WAHYUDI BOTt"])
        except:
            count += 1
            if(count == 50):
                sys.exit(0)
